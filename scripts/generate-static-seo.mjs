...
console.log(`Generated ${manufacturers.length} profile routes, ${landingConfig.categories.length} category routes, ${eligibleCities.length} city routes, 1 buyer request route, ${policyPages.length} policy routes, ${guideArticles.length + 1} guide routes, sitemap.xml and robots.txt.`);
