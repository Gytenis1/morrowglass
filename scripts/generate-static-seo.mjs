...
const requestDescription = 'Struktūruota baldų projekto RFQ užklausa operatoriaus peržiūrai, be automatinio siuntimo gamintojams ir su atskiru patvirtinimu prieš išsiuntimą.';
const requestBody = `${header('request')}<main class="request-main rfq-main"><section class="request-intro" aria-labelledby="request-title"><div><p class="kicker">Saugi projekto užklausa</p><h1 id="request-title">Parenkite vienodą baldų projekto RFQ</h1><p class="lead">Pateikite projekto santrauką operatoriaus peržiūrai. Gamintojai nekontaktuojami automatiškai.</p></div><aside class="request-expectation"><h2>Svarbi proceso riba</h2><p>Formos pateikimas tik sukuria privatų peržiūros įrašą. Siuntimui būtinas atskiras patvirtinimas.</p></aside></section><section class="rfq-process"><div class="section-heading"><h2>Kaip vyksta užklausa</h2></div><ol><li><strong>Pirkėjas pateikia santrauką.</strong><span>Ji perduodama operatoriaus peržiūrai.</span></li><li><strong>Operatorius tikrina briefą ir kandidatus.</strong><span>Vertinama informacija ir tinkamumo prielaidos.</span></li><li><strong>Siunčiama tik po atskiro patvirtinimo.</strong><span>Iki jo tiekėjai nekontaktuojami.</span></li><li><strong>Po išsiuntimo skiriamos penkios dienos.</strong><span>Terminas skaičiuojamas nuo faktinio išsiuntimo.</span></li><li><strong>Grąžinami palyginami atsakymai.</strong><span>Gautų pasiūlymų skaičius negarantuojamas.</span></li></ol></section><section aria-labelledby="request-form-title"><div class="section-heading"><h2 id="request-form-title">Projekto ir kontaktiniai duomenys</h2><p>Interaktyvi RFQ forma ir katalogo kandidatų pasirinkimas parengiami įkėlus puslapį.</p></div><div class="request-static-loading" role="status"><p>Ruošiama saugi RFQ forma…</p></div></section></main>${footer()}`;
